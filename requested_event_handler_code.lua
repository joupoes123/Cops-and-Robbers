AddEventHandler('cnr:requestMyInventory', function()
    ...
    if pData and pData.inventory then
        ...
        for itemId, itemData in pairs(pData.inventory) do
            ...
            if itemConfig then
                ...
                nuiInventory[itemId] = {
                 ...
                 -- This uses the main Log function, which might be filtered by Config.DebugLogging
        ...
        print(string.format("[CNR_DIAGNOSTIC_PRINT] Player %s raw inventory item count before NUI processing: %d", src, tablelength(pData.inventory))) -- Assuming tablelength is accessible
