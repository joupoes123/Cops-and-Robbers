...
AddEventHandler('cnr:requestMyInventory', function()
    ...
    if pData and pData.inventory then
        ...
        print(string.format("[CNR_DIAGNOSTIC_PRINT] Player %s raw inventory item count before NUI processing: %d", src, tablelength(pData.inventory)))
        ...
        print(string.format("[CNR_DIAGNOSTIC_PRINT] Inventory sample being sent to player %s: %s", src, json.encode(nuiInventorySampleForLog)))
        ...
        print(string.format("[CNR_DIAGNOSTIC_PRINT] No inventory data found for player %s or pData is nil. Sending empty inventory.", src))
